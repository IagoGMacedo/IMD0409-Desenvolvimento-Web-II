...
public class CreditCardController {
    ...
    @PostMapping
    public ResponseEntity<CreditCardDTO> save(@RequestBody CreditCardDTO CreditCard) {
        return new ResponseEntity<CreditCardDTO>((creditCardService.save(CreditCard)), HttpStatus.CREATED);
    }
    ...
    @PutMapping("{id}")
    public ResponseEntity<CreditCardDTO> update(@PathVariable Integer id, @RequestBody CreditCardDTO CreditCard) {
        return new ResponseEntity<CreditCardDTO>((creditCardService.update(id, CreditCard)), HttpStatus.OK);
    }
    ...
    @PatchMapping("{id}")
    public ResponseEntity<CreditCardDTO> patch(@PathVariable Integer id, @RequestBody CreditCardDTO CreditCardIncompletaDTO) {
        return new ResponseEntity<CreditCardDTO>((creditCardService.patch(id, CreditCardIncompletaDTO)), HttpStatus.OK);
    }
    ...
    @GetMapping
    public ResponseEntity<List<CreditCardDTO>> find(CreditCard filtro) {
        return new ResponseEntity<List<CreditCardDTO>>((creditCardService.findAll(filtro)), HttpStatus.OK);
    }
}
